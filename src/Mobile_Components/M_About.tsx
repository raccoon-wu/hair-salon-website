...
export default function M_About() {
    ...
    return (
        <>
        <div id="m-about-section" className="flex flex-col h-full justify-center items-center my-10">
            <h3 className="text-white mb-5">WHY CHOOSE US?</h3>
            <div {...aboutDiv}>
                <FiThumbsUp {...aboutIcons}/>
                <div {...aboutText}>
                    <p className="text-rg text-white font-JostM">Experience</p>
                    <p className="text-sm text-white font-JostL">Hairdressers with more than 20 years of experience working with hair</p>
                </div>
            </div>
            <div {...aboutDiv}>
                ...
                <div {...aboutText}>
                    ...
                    <p className="text-sm text-white font-JostL">Commitment to friendly, professional service ensures our customers leaves satisfied</p>
                </div>
            </div>
            <div {...aboutDiv}>
                ...
                <div {...aboutText}>
                    ...
                    <p className="text-sm text-white font-JostL">Discover the best prices in the Forest Hill Chase area</p>
                </div>
            </div>
        </div>
